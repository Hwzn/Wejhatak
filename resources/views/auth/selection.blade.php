...
<body>
    ...
    <div class="wrapper">
    <!-- <a href="{{route('register')}}" class="button"><span>Register</span><i class="fa fa-check"></i></a> -->
                ...
                <div class="row justify-content-center no-gutters vertical-align">
                    ...
                    <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            <h3 style="font-family: 'Cairo', sans-serif;text-align:center" class="mb-30">Login Form</h3>
                            <hr>
