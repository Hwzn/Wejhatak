<div class="modal fade" id="editModolad_Package" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                            ...
                            {{ trans('packages_trans.add_packafffge') }}
                        </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control"  id="addGrad_Name" name="destnation_en"
                                      ...
                                      <input type="hidden" class="form-control"  id="addGrad_Name" name="package_id"
                                        class="form-control">
                                      @error('Name_en')
